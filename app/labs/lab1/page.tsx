    ...
    <div id="wd-lab1">
      ...
      <div id="wd-p-tag">
        ...
        <p id="wd-p-3">
          ...
          Even though there is a deliberate white gap between the paragraph above and this paragraph, by default browsers render them as one contiguous piece of text as shown here on the right.
        </p>
        <p id="wd-p-4"> This is the third paragraph. 
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Defrost chicken.</li>
          <li>Chop chicken into chunks.</li>
          <li>Sear chicken in a pan until sides are golden brown.</li>
          <li>Add sauce of choice to pan.</li>
          <li>Reduce sauce until desired consistency.</li>
          <li>While reducing, prepare serving of rice to your liking.</li>
          <li>While plating, set oven to 350 Farenheit and heat a frozen naan for 2 minutes.</li>
          <li>Serve hot.</li>
        </ol>
      ...
      <div id="wd-forms">
        ...
        <h4>Anchor tag</h4>
          Please
          <a href="https://github.com/LuckyRandomness/kambaz-next-js" id="wd-lipsum">click here</a>
